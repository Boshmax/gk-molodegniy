...
union all select  2, 2, 1, 9, 'http://s3.uploads.ru/sUBER.png', 1, 11
union all select  3, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  4, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  5, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  6, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  7, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  8, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 11
union all select  9, 2, 1, 9, 'http://s3.uploads.ru/kftCI.png', 1, 10
...
union all select  2, 2, 3, 9, 'http://s2.uploads.ru/kOoQr.png', 1, 10
union all select  3, 2, 3, 9, 'http://s2.uploads.ru/6Nw75.png', 1, 10
union all select  4, 2, 3, 9, 'http://s3.uploads.ru/lvrIG.png', 1, 10
union all select  5, 2, 3, 9, 'http://s2.uploads.ru/DClWh.png', 1, 10
union all select  6, 2, 3, 9, 'http://s2.uploads.ru/DClWh.png', 1, 10
union all select  7, 2, 3, 9, 'http://s2.uploads.ru/DClWh.png', 1, 10
