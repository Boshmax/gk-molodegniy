...
union	all	select		2,	2,	1,	11,	'http://s3.uploads.ru/sUBER.png',	1,	11
union	all	select		3,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		4,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		5,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		6,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		7,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		8,	2,	1,	11,	'http://s3.uploads.ru/kftCI.png',	1,	11
union	all	select		9,	2,	1,	10,	'http://s3.uploads.ru/kftCI.png',	1,	10
union	all	select		10,	2,	1,	9,	'http://s2.uploads.ru/g2NFy.png',	1,	9
union	all	select		11,	2,	1,	9,	'http://s2.uploads.ru/g2NFy.png',	1,	9
union	all	select		12,	2,	1,	9,	'http://s2.uploads.ru/g2NFy.png',	1,	9
union	all	select		13,	2,	1,	9,	'http://s3.uploads.ru/RwYuc.png',	1,	9
union	all	select		14,	2,	1,	9,	'http://s3.uploads.ru/RwYuc.png',	1,	9
union	all	select		15,	2,	1,	9,	'http://s3.uploads.ru/RwYuc.png',	1,	9
union	all	select		16,	2,	1,	9,	'http://s3.uploads.ru/RwYuc.png',	1,	9
union	all	select		17,	2,	1,	9,	'http://s3.uploads.ru/RwYuc.png',	1,	9
union	all	select		18,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		19,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		20,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		21,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		22,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		23,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		24,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		25,	2,	1,	9,	'http://s2.uploads.ru/5eS47.png',	1,	9
union	all	select		2,	2,	2,	9,	'http://s2.uploads.ru/spfAX.png',	1,	9
union	all	select		3,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		4,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		5,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		6,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		7,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		8,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		9,	2,	2,	9,	'http://s3.uploads.ru/WGbS8.png',	1,	9
union	all	select		10,	2,	2,	9,	'http://s3.uploads.ru/oIGvw.png',	1,	9
union	all	select		11,	2,	2,	9,	'http://s3.uploads.ru/oIGvw.png',	1,	9
union	all	select		12,	2,	2,	9,	'http://s3.uploads.ru/oIGvw.png',	1,	9
union	all	select		13,	2,	2,	9,	'http://s3.uploads.ru/34ka0.png',	1,	9
union	all	select		14,	2,	2,	9,	'http://s3.uploads.ru/34ka0.png',	1,	9
union	all	select		15,	2,	2,	9,	'http://s3.uploads.ru/34ka0.png',	1,	9
union	all	select		16,	2,	2,	9,	'http://s3.uploads.ru/34ka0.png',	1,	9
union	all	select		17,	2,	2,	9,	'http://s3.uploads.ru/34ka0.png',	1,	9
union	all	select		18,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		19,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		20,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		21,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		22,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		23,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		24,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		25,	2,	2,	9,	'http://s2.uploads.ru/JzVC4.png',	1,	9
union	all	select		2,	2,	3,	10,	'http://s2.uploads.ru/kOoQr.png',	1,	10
union	all	select		3,	2,	3,	10,	'http://s2.uploads.ru/6Nw75.png',	1,	10
union	all	select		4,	2,	3,	10,	'http://s3.uploads.ru/lvrIG.png',	1,	10
union	all	select		5,	2,	3,	10,	'http://s2.uploads.ru/DClWh.png',	1,	10
union	all	select		6,	2,	3,	10,	'http://s2.uploads.ru/DClWh.png',	1,	10
union	all	select		7,	2,	3,	10,	'http://s2.uploads.ru/DClWh.png',	1,	10
union	all	select		8,	2,	3,	9,	'http://s2.uploads.ru/DClWh.png',	1,	9
union	all	select		9,	2,	3,	9,	'http://s2.uploads.ru/DClWh.png',	1,	9
union	all	select		10,	2,	3,	9,	'http://s2.uploads.ru/q7Pe2.png',	1,	9
union	all	select		11,	2,	3,	9,	'http://s3.uploads.ru/lxbcV.png',	1,	9
union	all	select		12,	2,	3,	9,	'http://s3.uploads.ru/rmbBO.png',	1,	9
union	all	select		13,	2,	3,	9,	'http://s2.uploads.ru/cnQK2.png',	1,	9
union	all	select		14,	2,	3,	9,	'http://s2.uploads.ru/cnQK2.png',	1,	9
union	all	select		15,	2,	3,	9,	'http://s2.uploads.ru/cnQK2.png',	1,	9
union	all	select		16,	2,	3,	9,	'http://s2.uploads.ru/cnQK2.png',	1,	9
union	all	select		17,	2,	3,	9,	'http://s2.uploads.ru/cnQK2.png',	1,	9
union	all	select		18,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		19,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		20,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		21,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		22,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		23,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		24,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
union	all	select		25,	2,	3,	9,	'http://s3.uploads.ru/u67hU.png',	1,	9
